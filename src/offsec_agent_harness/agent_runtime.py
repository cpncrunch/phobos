...
_NATIVE_TOOL_CALL_MILESTONE_CONTRACT = {
    ...
    "chat_completions_sse_legacy_function_call_translation": True,
    "responses_api_endpoint_planning": True,
    "gemini_generate_content_planning": True,
    "gemini_stream_generate_content_translation": True,
    "anthropic_messages_api_planning": True,
    "anthropic_messages_tool_use_alias_translation": True,
    "anthropic_messages_sse_tool_use_stream_translation": True,
    "anthropic_converse_stream_tool_use_translation": True,
    "bedrock_converse_message_tool_use_translation": True,
    "bedrock_converse_stream_tool_use_translation": True,
    "choice_singular_wrapper_translation": True,
    ...
    "streamed_tool_name_fragment_assembly": True,
    "choice_delta_choice_index_isolation": True,
    "tool_calls_nested_alias_translation": True,
    "tool_calls_nested_tool_object_translation": True,
    "tool_call_object_map_translation": True,
    "legacy_function_call_translation": True,
    "responses_output_tool_call_translation": True,
    "responses_stream_event_function_call_translation": True,
    "responses_stream_sse_capture_translation": True,
    "responses_stream_call_id_delta_alias_translation": True,
    "responses_stream_argument_json_alias_translation": True,
    ...
    "candidate_direct_function_call_translation": True,
    "single_candidate_object_translation": True,
    "candidate_singular_wrapper_translation": True,
    "root_message_wrapper_translation": True,
    "root_messages_wrapper_translation": True,
    "root_contents_wrapper_translation": True,
    "root_predictions_wrapper_translation": True,
    "root_prediction_singular_wrapper_translation": True,
    ...
    "root_output_items_object_map_translation": True,
    "root_output_item_singular_wrapper_translation": True,
    "root_items_wrapper_translation": True,
    "root_item_singular_wrapper_translation": True,
    ...
    "provider_list_envelope_wrapper_translation": True,
    "provider_plural_envelope_wrapper_translation": True,
    ...
    "root_neutral_tool_alias_translation": True,
    "message_tool_use_alias_translation": True,
    "message_neutral_tool_alias_translation": True,
    ...
    "candidate_part_call_id_alias_translation": True,
    "provider_argument_alias_translation": True,
    "provider_tool_name_alias_translation": True,
    "provider_function_call_id_alias_translation": True,
    ...
    return {
        ...
        "native_tool_calling": {
            ...
            "provider_native_tool_call_variants": [
                ...
                "openai_chat_completions_sse_legacy_function_call",
                "openai_responses_api",
                "gemini_generate_content",
                "gemini_stream_generate_content",
                "anthropic_messages_api",
                "anthropic_messages_tool_use",
                "anthropic_messages_toolUse",
                "anthropic_messages_sse_tool_use",
                "anthropic_converse_stream_toolUse",
                "bedrock_converse_message_toolUse",
                "bedrock_converse_stream_toolUse",
                "choice_singular_wrapper",
                "choices_collapsed_object",
                ...
                "streamed_tool_name_fragments",
                "choice_delta_choice_index_isolation",
                "tool_calls_nested_functionCall",
                "tool_calls_nested_toolUse",
                "tool_calls_nested_tool",
                "tool_calls_object_map",
                "flat_tool_calls",
                ...
                "candidate_part_call_id_alias",
                "single_content_block_tool_call",
                "top_level_content_block_tool_use",
                "responses_output_function_call",
                "responses_stream_function_call",
                "responses_stream_sse_function_call",
                "responses_stream_call_id_delta_alias",
                "responses_stream_argument_json_alias",
                ...
                "candidate_direct_function_call",
                "single_candidate_object",
                "candidate_singular_wrapper",
                ...
                "root_messages_tool_calls",
                "root_messages_toolCalls",
                "root_messages_tool_call",
                "root_messages_toolCall",
                "root_messages_tool_use",
                "root_messages_tool",
                "root_messages_toolUse",
                "root_messages_tool_uses",
                "root_messages_toolUses",
                "root_messages_functionCall",
                "root_messages_functionCalls",
                "root_messages_function_calls",
                "root_messages_content_functionCall",
                "root_messages_content_parts_functionCall",
                "root_contents_content_functionCall",
                "root_contents_content_parts_functionCall",
                "root_predictions_tool_calls",
                "root_prediction_tool_calls",
                "root_outputs_tool_calls",
                "root_outputs_function_call",
                "root_outputs_function",
                "root_output_items_function_call",
                "root_output_items_function",
                "root_output_items_object_map",
                "root_outputItems_function_call",
                "root_outputItems_function",
                "root_output_item_function_call",
                "root_output_item_function",
                "root_outputItem_function_call",
                "root_outputItem_function",
                "root_items_function_call",
                "root_items_function",
                "root_item_function_call",
                "root_item_function",
                "provider_response_envelope_wrapper",
                "provider_result_envelope_wrapper",
                "provider_data_envelope_wrapper",
                "provider_list_envelope_wrapper",
                "provider_plural_envelope_wrapper",
                "root_functionCall",
                "root_functionCalls",
