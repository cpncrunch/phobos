...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--provider", default="heuristic", choices=["heuristic", "openai", "openai-compatible", "openai-responses", "responses", "gemini", "google", "google-gemini", "anthropic", "claude", "local", "ollama", "hermes", "hermes-cli"])
