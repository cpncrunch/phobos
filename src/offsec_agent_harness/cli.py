...
def build_parser() -> argparse.ArgumentParser:
    ...
    model = sub.add_parser("model-draft", help="Use a heuristic/OpenAI-compatible/local/Hermes adapter for role-specific drafting")
    model.add_argument("--provider", default="heuristic", choices=["heuristic", "openai", "openai-compatible", "local", "ollama", "hermes", "hermes-cli"])
